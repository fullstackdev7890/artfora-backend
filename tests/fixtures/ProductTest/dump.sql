...
INSERT INTO users(id, "2fa_type", username, tagname, email, role_id, phone, description, country, external_link, data, background_image_id, avatar_image_id, password, remember_token, reset_password_hash, created_at, updated_at, email_verified_at, deleted_at, email_verification_token, email_verification_token_sent_at, otp_secret) VALUES
  (1, 'email', 'Admin', 'admin', 'admin@example.com', 1, '1111111', 'Lorem ipsum well you know', 'USA', null, '{ "media_filters": {} }'::jsonb, null, null, '$2y$10$JSlPT99kMrhDE815OEQKaezYdlgcB0S0uwiOhNnoonyUMc0yQ7KEm', null, null, '2016-10-20 11:05:00', '2016-10-20 11:05:00', '2016-10-20 11:05:00', null, null, null, null),
  (2, 'email', 'User owner of some products', 'owner', 'owner@example.com', 2, '2222222', 'Lorem ipsum well you know', 'USA', null, '{ "media_filters": {} }'::jsonb, null, null, 'old_password', null, 'restore_token', '2016-10-20 11:05:00', '2016-10-20 11:05:00', '2016-10-20 11:05:00', null, null, null, null),
  (3, 'email', 'User without products', 'user', 'user@example.com', 2, '333333', 'Lorem ipsum well you know', 'USA', null, '{ "media_filters": {} }'::jsonb, null, null, 'old_password', null, 'restore_token', '2016-10-20 11:05:00', '2016-10-20 11:05:00', '2016-10-20 11:05:00', null, null, null, null);
...
INSERT INTO products(id, price, user_id, category_id, title, author, slug, description, is_ai_safe, visibility_level, width, height, weight, status, tags, created_at, updated_at) VALUES
  ...
  (2, 900, 2, 1, 'Second', 'Shishkin', 'second', 'Lorem ipsum', true, 1, 100, 200, 0.4, 'Rejected', 'Second, Shishkin, Some, Tags', '2016-10-21 11:05:00', '2016-10-20 11:05:00'),
  ...
  (4, 700, 2, 4, 'Fourth', 'Aivazovkiy', 'fourth', 'Lorem ipsum', false, 3, 100, 200, 0.4, 'Approved', 'Fourth, Aivazovkiy, Some, Tags', '2016-10-23 11:05:00', '2016-10-20 11:05:00'),
  ...
  (6, 500, 2, 3, 'Sixth', 'Picasso', 'sixth', 'Lorem ipsum', true, 1, 100, 200, 0.4, 'Pending', 'Sixth, Picasso, Some, Tags', '2016-10-25 11:05:00', '2016-10-20 11:05:00'),
